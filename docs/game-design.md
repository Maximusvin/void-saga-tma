...
Standard summon використовує відкриті odds `Common 65% · Rare 26.2% · Epic 8% · Legendary 0.8%`. Snapshot schema v7 зберігає server-authoritative Legendary pity: після 60 невдач кожен roll додає 3 процентні пункти до Legendary rate, а 80-та спроба гарантує Legendary. Rarity визначається до template, тому новий герой не роздуває шанс своєї rarity. Новий character отримує 30 gems на три summon. Ascension sink залежить від rarity: Common коштує 3 shards, Rare/Epic — 2, Legendary — 3; duplicate rewards лишаються `1/2/3/5`.
