...
const VIDEO_URL = '/prototypes/hero-animation/assets/hero/mage-avatar.mp4';
...
lede.className = 'lede';
lede.textContent =
  'Рух згенерований AI (Kling image-to-video) з вашого мага: субтильне дихання, ' +
  'моргання й м’який рух — персонаж лишається цілим, як у грі, не «гумова» ' +
  'деформація. Оптимізовано: 5.4 МБ → 262 КБ (448px, H.264, безшовний boomerang-луп).';
